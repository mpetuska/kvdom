package lt.petuska.kvdom.dom.w3c.workers
...
inline fun RegistrationOptions(
...
public open external class ServiceWorkerMessageEvent(
  type: String,
  eventInitDict: ServiceWorkerMessageEventInit = definedExternally
) : Event {
  open val data: Any?
...
@kotlin.internal.InlineOnly
inline fun ServiceWorkerMessageEventInit(
  data: Any? = undefined,
 ...
 */
public open external class ExtendableEvent(type: String, eventInitDict: ExtendableEventInit = definedExternally) :
  Event {
...
@kotlin.internal.InlineOnly
inline fun ExtendableEventInit(
  bubbles: Boolean? = false,
  cancelable: Boolean? = false,
  composed: Boolean? = false
): ExtendableEventInit {
 ...
 */
public open external class InstallEvent(type: String, eventInitDict: ExtendableEventInit = definedExternally) :
  ExtendableEvent {
...
@kotlin.internal.InlineOnly
inline fun ForeignFetchEventInit(
  request: Request?,
  origin: String? = "null",
  bubbles: Boolean? = false,
  cancelable: Boolean? = false,
...
@kotlin.internal.InlineOnly
inline fun ForeignFetchResponse(
  response: Response?,
  origin: String? = undefined,
...
@kotlin.internal.InlineOnly
inline fun ExtendableMessageEventInit(
  data: Any? = undefined,
  origin: String? = undefined,
  lastEventId: String? = undefined,
...
@kotlin.internal.InlineOnly
inline fun CacheBatchOperation(
