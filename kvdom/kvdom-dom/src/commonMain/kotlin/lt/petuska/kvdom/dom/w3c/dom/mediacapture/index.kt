...
inline fun MediaTrackSupportedConstraints(
  width: Boolean? = true,
  height: Boolean? = true,
...
@kotlin.internal.InlineOnly
inline fun MediaTrackCapabilities(
...
@kotlin.internal.InlineOnly
inline fun MediaTrackConstraints(
...
@kotlin.internal.InlineOnly
inline fun MediaTrackConstraintSet(
  width: dynamic = undefined,
  height: dynamic = undefined,
  aspectRatio: dynamic = undefined,
  frameRate: dynamic = undefined,
...
@kotlin.internal.InlineOnly
inline fun MediaStreamTrackEventInit(
...
@kotlin.internal.InlineOnly
inline fun OverconstrainedErrorEventInit(
  error: dynamic = null,
  bubbles: Boolean? = false,
  cancelable: Boolean? = false,
  composed: Boolean? = false
...
@kotlin.internal.InlineOnly
inline fun ConstrainDoubleRange(
...
@kotlin.internal.InlineOnly
inline fun ConstrainULongRange(
  exact: Int? = undefined,
  ideal: Int? = undefined,
  max: Int? = undefined,
  min: Int? = undefined
...
@kotlin.internal.InlineOnly
inline fun ConstrainBooleanParameters(
...
@kotlin.internal.InlineOnly
inline fun ConstrainDOMStringParameters(
...
inline val MediaStreamTrackState.Companion.LIVE: MediaStreamTrackState
  get() = "live".asDynamic().unsafeCast<MediaStreamTrackState>()
...
inline val VideoFacingModeEnum.Companion.USER: VideoFacingModeEnum
  get() = "user".asDynamic().unsafeCast<VideoFacingModeEnum>()

inline val VideoFacingModeEnum.Companion.ENVIRONMENT: VideoFacingModeEnum
  get() = "environment".asDynamic().unsafeCast<VideoFacingModeEnum>()

inline val VideoFacingModeEnum.Companion.LEFT: VideoFacingModeEnum
  get() = "left".asDynamic().unsafeCast<VideoFacingModeEnum>()

inline val VideoFacingModeEnum.Companion.RIGHT: VideoFacingModeEnum
...
inline val VideoResizeModeEnum.Companion.NONE: VideoResizeModeEnum
  get() = "none".asDynamic().unsafeCast<VideoResizeModeEnum>()

inline val VideoResizeModeEnum.Companion.CROP_AND_SCALE: VideoResizeModeEnum
