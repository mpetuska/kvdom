 ...
 */
@NoWASM
expect abstract class Window : EventTarget, GlobalEventHandlers,
  WindowEventHandlers,
  ...
  fun postMessage(message: Any?, targetOrigin: String, transfer: Array<Dynamic> = arrayOf())
  fun captureEvents()
  fun releaseEvents()
  ...
  fun scroll(options: ScrollToOptions = ScrollToOptions())
  fun scroll(x: Double, y: Double)
  fun scrollTo(options: ScrollToOptions = ScrollToOptions())
  fun scrollTo(x: Double, y: Double)
  fun scrollBy(options: ScrollToOptions = ScrollToOptions())
  fun scrollBy(x: Double, y: Double)
  fun getComputedStyle(elt: Element, pseudoElt: String? = null): CSSStyleDeclaration
}

@NoWASM
expect operator fun Window.get(name: String): Dynamic