...
expect inline operator fun HTMLFormElement.get(index: Int): Element?

expect inline operator fun HTMLFormElement.get(name: String): UnionElementOrRadioNodeList?
